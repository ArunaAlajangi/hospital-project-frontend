  ...
  <div>
    ...
    <div className='flex flex-col sm:flex-row gap-4'>
      ...
      <div className=' flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
        ...
        <p className=' flex items-center gap-2 text-2xl font-medium text-gray-900'>{docInfo.name} <img className='w-8' src={assets.logo3} alt=''/></p>
        ...
        {/*======== Doctor About ========== */}
        <div>
          <p className='flex items-center gap-1 text-sm font-medium text-gray-900 mt-3'> About <img className="w-5" src={assets.logo2} alt=''/></p>
    ...
    <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
      <p>Booking Slots</p>
      <div className='flex gap-3 items-center w-full overflow-x-scroll whitespace-nowrap mt-4'>
        {
      ...
      <div className='flex items-center gap-3 w-full overflow-x-scroll whitespace-nowrap touch-scroll-auto  mt-4'>
